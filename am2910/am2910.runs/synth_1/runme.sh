...
HD_PWD='D:/AMD/AM2910/am2910/am2910.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log am2910.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source am2910.tcl
