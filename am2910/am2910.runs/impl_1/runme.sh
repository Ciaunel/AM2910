...
HD_PWD='D:/AMD/AM2910/am2910/am2910.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log am2910.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source am2910.tcl -notrace
