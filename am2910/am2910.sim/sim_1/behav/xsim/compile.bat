...
REM
REM Generated by Vivado on Wed Jul 23 17:23:47 +0300 2025
...
echo "xvlog --incr --relax -prj tb_am2910_vlog.prj"
call xvlog  --incr --relax -prj tb_am2910_vlog.prj -log xvlog.log
